...
**Topic:** `Array`, `String`, `Hash Table`, `Greedy`, `Counting`.

<div class="_1l1MA"><p>You are given an array of strings <code>words</code>. Each element of <code>words</code> consists of <strong>two</strong> lowercase English letters.</p>
