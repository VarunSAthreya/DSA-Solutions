...
3. `i` <sup>th</sup> rectangle = `rects[i]` = `[x1,y1,x2,y2]`, where `[x1, y1]` are the integer coordinates of the bottom-left corner, and `[x2, y2]` are the 4.integer coordinates of the top-right corner.
